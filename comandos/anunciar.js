...
module.exports.run = async (client, message, args) => {
  const perm = new Discord.RichEmbed()
    ...
    .addField(
      ...
      `Você tem que o adicionar o seguinte cargo em você: **"Perm da Isabella 💸"** que ja foi criado na minha entrada no servidor, caso não tenha crie!`
    );

  if (!message.member.roles.some(r => ["Perm da Isabella 💸"].includes(r.name)))
